...
import 'package:video_player_platform_view_example/video_play_page.dart';

void main() {
  runApp(MaterialApp(routes: {
    "/video_play_page": (context) => VideoPlayPage(),
  }, home: const MyApp()));
}
...
class _MyAppState extends State<MyApp> {
  ...
  final _videoPlayerPlatformViewPlugin = VideoPlayerPlatformView();
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await _videoPlayerPlatformViewPlugin.getPlatformVersion() ?? 'Unknown platform version';
